...
public:
	...
	*/
	...
	void render(PNG & rendpng, Node* subRoot);
	...
	*/
	...
	//helper function
	void prune(double pct, int tol, Node* subRoot);
	long getTolleafNumber(int tol, Node* subRoot, RGBAPixel subavg);
	long getLeafNumber(Node* subRoot);
